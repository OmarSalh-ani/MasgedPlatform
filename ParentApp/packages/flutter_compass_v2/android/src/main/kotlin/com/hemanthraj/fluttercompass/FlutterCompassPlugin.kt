...
class FlutterCompassPlugin : FlutterPlugin, EventChannel.StreamHandler {
    ...
    private var loggedUnreliableWarning = false
        ...
        override fun onAccuracyChanged(sensor: Sensor, accuracy: Int) {
            when (sensor.type) {
                Sensor.TYPE_MAGNETIC_FIELD -> if (lastAccuracySensorStatus != accuracy) {
                    ...
                    if (accuracy == SensorManager.SENSOR_STATUS_UNRELIABLE && !loggedUnreliableWarning) {
                        loggedUnreliableWarning = true
