...
import { CircleMemorizationRevisionReportPage } from '@/pages/circle-memorization-revision-report/CircleMemorizationRevisionReportPage'
import { CircleRatingFormPage } from '@/pages/circle-ratings/CircleRatingFormPage'
import { CircleRatingsPage } from '@/pages/circle-ratings/CircleRatingsPage'
    ...
    children: [
      ...
      { path: 'test-certificate', element: <TestCertificatePage /> },
      {
        ...
        children: [
          ...
          {
            path: 'circle-memorization-revision-report',
            element: <CircleMemorizationRevisionReportPage />,
          },
          { path: 'circle-ratings/new', element: <CircleRatingFormPage /> },
          { path: 'circle-ratings', element: <CircleRatingsPage /> },
