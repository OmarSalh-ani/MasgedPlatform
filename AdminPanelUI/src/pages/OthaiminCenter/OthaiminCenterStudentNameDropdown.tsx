...
import { useOthaiminCenterStudentNames } from '@/hooks/useOthaiminCenter'
import { HOME_STUDENT_NAME_LOOKUP_PAGE_SIZE } from '@/types/home'

interface OthaiminCenterStudentNameDropdownProps {
  value: string
...
export function OthaiminCenterStudentNameDropdown({ value, onChange }: OthaiminCenterStudentNameDropdownProps) {
  ...
  const namesQuery = useOthaiminCenterStudentNames(lookupFilters)
