...
import { useOthaiminCenterStudentTests } from '@/hooks/useOthaiminCenter'

interface OthaiminCenterStudentTestsDialogProps {
  open: boolean
...
export function OthaiminCenterStudentTestsDialog({
  open,
  studentId,
  studentName,
  onOpenChange,
}: OthaiminCenterStudentTestsDialogProps) {
  const testsQuery = useOthaiminCenterStudentTests(open ? studentId : null)
