...
import { useHomeStudentReviews } from '@/hooks/useHome'

interface StudentReviewsDialogProps {
  open: boolean
...
export function StudentReviewsDialog({ open, studentId, studentName, onOpenChange }: StudentReviewsDialogProps) {
  const reviewsQuery = useHomeStudentReviews(open ? studentId : null)
