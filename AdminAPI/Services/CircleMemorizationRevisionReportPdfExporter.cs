            ...
            container.Page(page =>
            {
                ...
                page.Header().Column(col =>
                {
                    col.Item().Row(row =>
                    {
                        ...
                        row.RelativeItem().Column(c =>
                        {
                            ...
                            c.Item().AlignCenter()
                                .Text("تقرير الحفظ والمراجعة لحلقة " + meta.CircleName).Bold().FontSize(13);
                            c.Item().AlignCenter()
                                .Text("تمت طباعته بواسطة المعلم " + meta.TeacherName).FontSize(11);
                            c.Item().AlignCenter()
                ...
                page.Content().PaddingTop(10).Table(table =>
                {
                    ...
                    static IContainer CellStyle(IContainer c) =>
                        c.Border(0.5f).Padding(4).AlignCenter().AlignMiddle();
